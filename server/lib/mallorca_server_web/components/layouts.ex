defmodule MallorcaServerWeb.Layouts do
  @moduledoc """
    ...
    <header class="bg-primary text-primary-content">
      <div class="mx-auto max-w-3xl flex items-center justify-between px-4">
        ...
        <nav class="flex items-stretch text-sm">
          <span class="hidden px-3 py-3 opacity-70 sm:inline">network mode</span>
          <a
            href="https://metasyn.srht.site/learn-orca/"
            class="px-3 py-3 hover:bg-success hover:text-success-content"
          >
            learn orca ↗
          </a>
        </nav>
